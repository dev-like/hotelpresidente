<style media="all">
    ...
    svg #botao{
        animation: botao 1s ease-out infinite;
    }
    svg #sino{
        animation: sino 1s ease-out infinite;
    }
    svg #som{
        transform-origin: center;
        animation: som 1s ease-out infinite;
    }
    @keyframes botao {
...
<div class="loader">
    <svg id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 78.83" width="120" height="120">
    	<defs>
    		<style>
    			.cls-1{fill:#58565c;}
    			.cls-2{fill:#ffd151;}
    	...
    	<g id="sino">
            <rect class="cls-1" x="29.65" y="61.8" width="20.71" height="6.7"/>
