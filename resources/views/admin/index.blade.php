    ...
    <div class="topbar">
      ...
      <div class="topbar-left">
        <a href="/admin" class="logo">
          <span>
            <img src="{{ asset('template/images/logohotel.png') }}" alt="" height="60">
          </span>
          <i>
            <img src="{{ asset('template/images/logohotel-small.png') }}" alt="" height="50">
          </i>
        </a>
      </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                <div class="card-box tilebox-one">
                    ...
                    <h4 class="mb-3" id="organico">Carregando</h4>
